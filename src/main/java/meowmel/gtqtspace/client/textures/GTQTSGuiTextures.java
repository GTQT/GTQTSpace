...
public class GTQTSGuiTextures {
    ...
    public static final TextureArea PROGRESS_BAR_MINING_MODULE = TextureArea.fullImage("textures/gui/progress_bar/e_progress_bar_mining_module.png");
