...
public class MetaTileEntityIndustrialForgeHammer extends MultiMapMultiblockController {

    private int pistonCasingTier;

    /* ------------------------------- MetaTileEntity constructors ------------------------------- */
    public MetaTileEntityIndustrialForgeHammer(ResourceLocation metaTileEntityId) {
    ...
    public MetaTileEntity createMetaTileEntity(IGregTechTileEntity tileEntity) {
        return new MetaTileEntityIndustrialForgeHammer(metaTileEntityId);
    }
    ...
    public void addInformation(ItemStack stack,
        ...
        tooltip.add(I18n.format("gtqtspace.machine.industrial_forge_hammer.tooltip.1"));
        tooltip.add(I18n.format("gtqtspace.machine.industrial_forge_hammer.tooltip.2"));
        tooltip.add(I18n.format("gtqtspace.machine.industrial_forge_hammer.tooltip.3"));
        tooltip.add(I18n.format("gtqtspace.machine.industrial_forge_hammer.tooltip.4"));
    }

    @Override
    public String[] getDescription() {
        return new String[]{
                I18n.format("gtqtspace.machine.industrial_forge_hammer.desc.1")
        };
    }
    ...
    protected class IndustrialForgeHammerRecipeLogic extends MultiblockRecipeLogic {
        ...
        public void setMaxProgress(int maxProgress) {
            super.setMaxProgress((int) (Math.floor(maxProgress * Math.pow(0.8, pistonCasingTier))));
        }

        @Override
        public int getParallelLimit() {
            return 4 * pistonCasingTier;
        }
