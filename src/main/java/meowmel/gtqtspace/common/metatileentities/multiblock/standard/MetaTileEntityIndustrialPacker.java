...
public class MetaTileEntityIndustrialPacker extends GTQTSpaceMultiblockController {

    private int robotArmCasingTier;

    /* ------------------------------- MetaTileEntity constructors ------------------------------- */
    public MetaTileEntityIndustrialPacker(ResourceLocation metaTileEntityId) {
        super(metaTileEntityId, new RecipeMap[]{
                RecipeMaps.PACKER_RECIPES
        });
        this.recipeMapWorkable = new IndustrialPackerRecipeLogic(this);
    }

    @Override
    public MetaTileEntity createMetaTileEntity(IGregTechTileEntity tileEntity) {
        return new MetaTileEntityIndustrialPacker(metaTileEntityId);
    }
    ...
    public void addInformation(ItemStack stack,
        ...
        tooltip.add(I18n.format("gtqtspace.machine.industrial_packer.tooltip.1"));
        tooltip.add(I18n.format("gtqtspace.machine.industrial_packer.tooltip.2"));
        tooltip.add(I18n.format("gtqtspace.machine.industrial_packer.tooltip.3"));
        tooltip.add(I18n.format("gtqtspace.machine.industrial_packer.tooltip.4"));
    }
    ...
    protected class IndustrialPackerRecipeLogic extends SpaceMultiblockRecipeLogic {

        public IndustrialPackerRecipeLogic(RecipeMapMultiblockController tileEntity) {
            super(tileEntity);
        }
        ...
        public void setMaxProgress(int maxProgress) {
            super.setMaxProgress((int) (Math.floor(maxProgress * Math.pow(0.5, robotArmCasingTier))));
        }

        @Override
        public int getParallelLimit() {
            return 8 * robotArmCasingTier;
        }
