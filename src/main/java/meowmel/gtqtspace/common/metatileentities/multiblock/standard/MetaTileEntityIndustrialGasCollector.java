...
public class MetaTileEntityIndustrialGasCollector extends GTQTSpaceMultiblockController {

    private int pumpCasingTier;

    /* ------------------------------- MetaTileEntity constructors ------------------------------- */
    public MetaTileEntityIndustrialGasCollector(ResourceLocation metaTileEntityId) {
        super(metaTileEntityId, new RecipeMap[]{
                RecipeMaps.GAS_COLLECTOR_RECIPES
        });
        this.recipeMapWorkable = new IndustrialGasCollectorRecipeLogic(this);
    }

    @Override
    public MetaTileEntity createMetaTileEntity(IGregTechTileEntity tileEntity) {
        return new MetaTileEntityIndustrialGasCollector(metaTileEntityId);
    }
    ...
    protected BlockPattern createStructurePattern() {
        return FactoryBlockPattern.start()
                ...
                .aisle("     ", "     ", "CDDDC", "GPDPG", "CDDDC")
                .aisle("F   F", "F   F", "CCCCC", "CCSCC", "CCCCC")
                .where('S', this.selfPredicate())
                .where('C', states(this.getCasingState())
                        .setMinGlobalLimited(8)
                        .or(this.autoAbilities(true, true, true, false, false, true, false)))
                .where('D', states(this.getSecondCasingState()))
    ...
    public void addInformation(ItemStack stack,
        ...
        tooltip.add(I18n.format("gtqtspace.machine.industrial_gas_collector.tooltip.1"));
        tooltip.add(I18n.format("gtqtspace.machine.industrial_gas_collector.tooltip.2"));
        tooltip.add(I18n.format("gtqtspace.machine.industrial_gas_collector.tooltip.3"));
        tooltip.add(I18n.format("gtqtspace.machine.industrial_gas_collector.tooltip.4"));
    }
    ...
    protected class IndustrialGasCollectorRecipeLogic extends SpaceMultiblockRecipeLogic {

        public IndustrialGasCollectorRecipeLogic(RecipeMapMultiblockController tileEntity) {
            super(tileEntity);
        }
