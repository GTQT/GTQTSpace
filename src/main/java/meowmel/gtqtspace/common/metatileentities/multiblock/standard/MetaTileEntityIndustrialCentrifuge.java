...
public class MetaTileEntityIndustrialCentrifuge extends GTQTSpaceMultiblockController {
    ...
    public void addInformation(ItemStack stack,
        ...
        tooltip.add(I18n.format("gtqtspace.machine.industrial_centrifuge.tooltip.1"));
        tooltip.add(I18n.format("gtqtspace.machine.industrial_centrifuge.tooltip.2"));
        tooltip.add(I18n.format("gtqtspace.machine.industrial_centrifuge.tooltip.3"));
        tooltip.add(I18n.format("gtqtspace.machine.industrial_centrifuge.tooltip.4"));
    }
    ...
    protected class IndustrialCentrifugeRecipeLogic extends SpaceMultiblockRecipeLogic {
