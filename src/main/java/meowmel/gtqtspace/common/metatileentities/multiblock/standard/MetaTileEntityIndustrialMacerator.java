...
public class MetaTileEntityIndustrialMacerator extends GTQTSpaceMultiblockController {
    ...
    public MetaTileEntityIndustrialMacerator(ResourceLocation metaTileEntityId) {
        ...
        this.recipeMapWorkable = new IndustrialMaceratorRecipeLogic(this);
    }
    ...
    public void addInformation(ItemStack stack,
        ...
        tooltip.add(I18n.format("gtqtspace.machine.industrial_macerator.tooltip.1"));
        tooltip.add(I18n.format("gtqtspace.machine.industrial_macerator.tooltip.2"));
        tooltip.add(I18n.format("gtqtspace.machine.industrial_macerator.tooltip.3"));
        tooltip.add(I18n.format("gtqtspace.machine.industrial_macerator.tooltip.4"));
    }
    ...
    protected class IndustrialMaceratorRecipeLogic extends SpaceMultiblockRecipeLogic {

        public IndustrialMaceratorRecipeLogic(RecipeMapMultiblockController tileEntity) {
            super(tileEntity);
        }
