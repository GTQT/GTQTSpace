...
public class MetaTileEntityIndustrialBrewery extends GTQTSpaceMultiblockController {
    ...
    public MetaTileEntityIndustrialBrewery(ResourceLocation metaTileEntityId) {
        ...
        this.recipeMapWorkable = new IndustrialBreweryRecipeLogic(this);
    }

    @Override
    public MetaTileEntity createMetaTileEntity(IGregTechTileEntity tileEntity) {
        return new MetaTileEntityIndustrialBrewery(metaTileEntityId);
    }
    ...
    public void addInformation(ItemStack stack,
        ...
        tooltip.add(I18n.format("gtqtspace.machine.industrial_brewery.tooltip.1"));
        tooltip.add(I18n.format("gtqtspace.machine.industrial_brewery.tooltip.2"));
        tooltip.add(I18n.format("gtqtspace.machine.industrial_brewery.tooltip.3"));
        tooltip.add(I18n.format("gtqtspace.machine.industrial_brewery.tooltip.4"));
    }

    @Override
    public String[] getDescription() {
        return new String[]{
                I18n.format("gtqtspace.machine.industrial_brewery.desc.1")
        };
    }
