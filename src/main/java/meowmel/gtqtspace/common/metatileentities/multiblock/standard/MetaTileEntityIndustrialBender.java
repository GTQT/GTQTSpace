...
public class MetaTileEntityIndustrialBender extends GTQTSpaceMultiblockController {
    ...
    protected class IndustrialBenderRecipeLogic extends SpaceMultiblockRecipeLogic {
