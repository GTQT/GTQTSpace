package keqing.gtqtspace.common.metatileentities.multiblock.standard.SpaceStation.SpaceDockSystem;
...
import keqing.gtqtspace.common.metatileentities.multiblock.standard.SpaceStation.AsteroidSystem.AsteroidUtils;
...
import static keqing.gtqtspace.common.metatileentities.multiblock.standard.SpaceStation.SpaceDockSystem.DockUtils.getSpeedValue;
import static keqing.gtqtspace.common.metatileentities.multiblock.standard.SpaceStation.SpaceDockSystem.DockUtils.getTypeByID;
...
public class DockManager extends MetaTileEntityBaseWithControl {
    ...
    protected void addDisplayText(List<ITextComponent> textList) {
        ...
        if (IDtoDeal != 0) {
            ...
            textList.add(new TextComponentTranslation("矿脉总数：%s 距离：%s", total, AsteroidUtils.TimeToSolve(IDtoDeal)));
            ...
            if (stack.getItem() == GTQTMetaItems.GTQT_META_ITEM && stack.getMetadata() == GTQTMetaItems.POS_BINDING_CARD.getMetaValue()) {
                ...
                if (compound != null && compound.hasKey("x") && compound.hasKey("y") && compound.hasKey("z")) {
                    ...
                    if (mte != null && !mte.work) {
                        ...
                        DockList[i][3] = AsteroidUtils.TimeToSolve(IDtoDeal) / DockList[i][1];
