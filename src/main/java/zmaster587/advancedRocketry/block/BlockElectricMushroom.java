...
public class BlockElectricMushroom extends BlockMushroom implements IGrowable {
    ...
    public boolean removedByPlayer(IBlockState state, World world, BlockPos pos, EntityPlayer player, boolean willHarvest) {
        // 替代 onBlockDestroyedByPlayer 的客户端特效逻辑
        if (world.isRemote) {
            ...
            world.playSound(pos.getX(), pos.getY(), pos.getZ(),
                    new SoundEvent(new ResourceLocation("advancedrocketry:ElectricShockSmall")),
                    SoundCategory.BLOCKS, .7f, 0.975f + world.rand.nextFloat() * 0.05f, false);
        }
