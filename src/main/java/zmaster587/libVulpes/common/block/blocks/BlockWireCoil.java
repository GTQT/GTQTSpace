...
public class BlockWireCoil extends VariantActiveBlock<BlockWireCoil.WireCoilType> {
    ...
    public enum WireCoilType implements IStringSerializable, IHeatingCoilBlockStats {
        ...
        COIL_SILICON("halkonite_steel", 16201, 32, 32, Materials.Silicon),
        COIL_TIN("adamantium", 12600, 16, 16, Materials.Copper),
        COIL_COPPER("cosmic_neutronium", 14400, 32, 16, Materials.Tin),
        COIL_STEEL("halkonite_steel", 16201, 32, 32, Materials.Silicon);
